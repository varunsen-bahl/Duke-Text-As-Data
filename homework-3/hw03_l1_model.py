...
This file contains the pipeline for the new model (logistic regression with L1)
...
clf = LogisticRegression(penalty="l1", solver="liblinear", max_iter=2000, n_jobs=1)
...
# saving outputs
with open("l1_model_outputs.txt", "w") as f:
